...
class CoNLLDataset(object):
    ...
    def __init__(self, filename, max_iter=None):
        ...
        self.roi_char_ids = np.load(self.filename + 'roi_char_ids.npy')
        ...
        self.left_context_word_features = np.load(self.filename + 'left_context_word_feature.npy')
        self.left_context_word_lens = np.load(self.filename + 'left_context_word_len.npy')
        self.right_context_word_features = np.load(self.filename + 'right_context_word_feature.npy')
